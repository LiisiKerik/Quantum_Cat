...
-- TODO: IMPROVE PERFORMANCE BY REPLACING LISTS WITH SEARCH TREES
-- TODO: INTEGRATION WITH PYTHON
...
-- TODO: FIX THE WRONG, REVERSED ORDER OF GATES THAT MAP INTRODUCES
...
-- TODO: BLANKS IN PATTERNS IN ALGEBRAIC DATA TYPE MATCHING + A DEFAULT VALUE
...
-- TODO: MAKE THE FILE WITH RND EXAMPLE NICER (NAMING ETC)
...
module Tree where
  ...
  instance Applicative Parser where
    Parser(p) <*> Parser(q) = Parser(\x -> case p(x) of
      Left(e) -> Left(e)
      Right(f, y) -> first(f) <$> q(y))
