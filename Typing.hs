...
module Typing where
  ...
  cmp(_)(Typevar'(_)) = error("Internal compiler error. Free type variable after type application.")
  cmp(_)(_) = False
  cmp_int :: Int_branch -> Int'' -> Bool
  cmp_int(Int_constant(m))(Const_int(n)) = m == n
  cmp_int(Int_variable(m))(Ext_int(n)) = m == n
  cmp_int(_)(Int_int(_)) = error("Internal compiler error. Free integer type variable after type application.")
  cmp_int(_)(_) = False
  constr_struct ::
  ...
  create_type_constr ::
    ...
    [Int_tree] ->
    Either(String)(Type)
  create_type_constr(m)(n)(t)(u)(l)(c)(con)(a)(b)(x)(y) =
    if length(x) == lt && length(y) == lu then
      (\(x', y') -> Struct_type(n)(x')(y')(m)) <$> create_type_constr'(con)(a)(b)(x)(y)
    else
      param_err(n)(l)(c)(toInteger(lt))(toInteger(lu)) where
        lt = length(t)
        lu = length(u)
  create_type_constr' ::
  ...
  dtype(r)(con)(b)(v)(w)(Expression_tree'(l)(c)(e)) =
    (\(e', t) -> (Expression_tree''(Code(l)(c))(e')(t), t)) <$> (case e of
      Expression_application'(e1)(e2) -> case dtype(r)(con)(b)(v)(w)(e1) of
        Left(err) -> Left(err)
        Right(e1', t1) -> case t1 of
  ...
  type_alg(glob)(loc)(c)(b)(d)(t)(u)(newt)(a) = case a of
    [] -> Right(glob, b, d)
    Algebraic_form_tree(line)(col)(n)(h) : tl -> case add_to_res(loc)(n)(line)(col) of
      Left(e) -> Left(e)
      Right(loc') -> case type_alg_fields(c)(0)(newt)(t)(u)(h) of
        Left(e) -> Left(e)
        Right(t') ->
          type_alg(
  ...
  type_field(glob)(loc)(c)(i)(st)(v)(w)(Argument_tree(line)(col)(x)(t)) =
    add_to_res(loc)(x)(line)(col) >>= \loc' -> case type_transf(c)(v)(w)(t) of
      Left(e) -> Left(e)
      Right(t') -> let
        b = Bind(Global(v)(w))(Function_type''(st)(t'))
        lc = Code(line)(col) in
          (Right(
            (x, Code(line)(col)) : glob,
            loc',
            (x, b),
            (x, Def_tree''(lc)(b)(Expression_tree''(lc)(Field''(i))(t'))),
            t'))
  type_fields ::
    [(String, Location)] ->
    [(String, Location)] ->
  ...
  type_struct_1(r)(c)(Data_tree(Decl_tree(line)(col)(x)(t)(u))(f)) = (, (x, Type_constr(create_type_constr(case f of
    ...
    Struct_tree(_) -> Nothing)(x)(t)(u))) : c) <$> add_to_res(r)(x)(line)(col)
  type_struct_2 ::
    [(String, Location)] ->
    [(String, Type_constr)] ->
    [(String, Bind)] ->
    ...
    Data_tree ->
    Either(String)([(String, Location)], [(String, Bind)], [(String, Def_tree'')])
  type_struct_2(r)(c)(b)(d)(Data_tree(Decl_tree(line)(col)(n)(t)(u))(x)) = case typevars(r)(t)(u) of
    Left(e) -> Left(e)
    Right(r', t', u') -> let
      newt = Struct_type(n)(Typevar <$> t')(Int_variable <$> u') in case x of
        ...
        Struct_tree(f) -> let newt' = newt(Nothing) in
          case type_fields(r)(r')(c)(b)(d)(0)(newt')(t')(u')(f) of
            Left(e) -> Left(e)
            Right(r'', _, b', d', t'') ->
              Right(
                r'',
                  ...
                  (
                    ...
                    Def_tree''(
                      ...
                      constr_struct(
                        Str'')(
                        [])(
                        (\(Argument_tree(ll)(cc)(_)(_)) -> (ll, cc)) <$> f)(
                        0)(
                        line)(
                        col)(
                        t'')(
